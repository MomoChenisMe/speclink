...
**Trigger**: When you encounter ambiguities while creating artifacts (during `/speclink:propose` or `/speclink:ingest`), or after analyze flags ambiguity/gap issues.
