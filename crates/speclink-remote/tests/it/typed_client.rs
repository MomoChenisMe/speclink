...
fn instructions_split_into_apply_and_artifact_typed_calls() {
    let mock = serve(
        200,
        r#"{"changeName":"demo","changeDir":"changes/demo","schemaName":"spec-driven","contextFiles":{"tasks":"tasks.md"},"progress":{"total":2,"complete":2,"remaining":0,"codeTotal":2,"codeComplete":2,"codeRemaining":0},"tasks":[{"id":"1","description":"1.1 First","done":true,"manual":false}],"state":"all_done","locale":"English","instruction":"Work through the tasks.\n"}"#,
    );
