...
4. **Assess delta spec sync state**
   ...
   Check for delta specs at `{{SPEC_DIR}}changes/<name>/specs/`. If none exist, proceed without sync prompt.

   **If delta specs exist:**
   - Compare each delta spec with its corresponding main spec at `{{SPEC_DIR}}specs/<capability>/spec.md`
