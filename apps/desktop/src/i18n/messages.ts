...
export const APP_MESSAGES: Record<UiLocale, Record<string, string>> = {
  "zh-TW": {
    ...
    "app.navSettings": "設定",
    "app.cancel": "取消",
    "app.promoteTitle": "轉為變更？",
    "app.promoteDesc":
      "會在「提案中」新增一張變更卡，提案內容以本討論的結論開頭；討論會移到「已轉出變更」區。",
    "app.changeName": "變更名稱",
    "app.changeNameHint": "（英文小寫，字間用 -）",
    "app.promoteConfirm": "轉為變更",
  ...
  en: {
    ...
    "app.cancel": "Cancel",
    "app.promoteTitle": "Promote to change?",
    "app.promoteDesc":
      "A new change card is added to Proposed, its proposal seeded from this discussion's conclusion; the discussion moves to the promoted group.",
    "app.changeName": "Change name",
    "app.changeNameHint": "(lowercase, words joined with -)",
    "app.promoteConfirm": "Promote",
