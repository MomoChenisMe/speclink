...
- Affected code:
  - New: crates/host/speclink-server/tests/it/api/plan_api.rs、crates/adapters/speclink-cli/tests/it/remote_plan.rs、apps/desktop/src/__tests__/helpers/changeList.ts（listChanges 替身的 payload 組裝）
