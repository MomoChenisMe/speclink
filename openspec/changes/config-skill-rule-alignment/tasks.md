...
- [x] 1.2 實作資產調整（綠）：crates/speclink-core/assets/skills/config.md 落 A–D 四處文字（對照 proposal What Changes 的 A–D 對照表與來源討論結論），crates/speclink-core/src/init.rs 的 MARKER_VERSION 自 v1.18.1 升至 v1.18.3（品質站修復輪自 v1.18.2 再遞增一次）。驗證:1.1 的新斷言全綠 <!-- speclink-task:tsk_01KZDDH9RH57SF6DW2GZ9PQE8Z -->
