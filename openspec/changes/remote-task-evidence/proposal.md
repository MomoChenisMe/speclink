...
- 影響 crate：speclink-core、speclink-host、speclink-server、speclink-store（含 memory supplier 與 conformance suite）、speclink-store-sqlite、speclink-store-fs、speclink-store-postgres；文件面在 docs/ 與 apps/desktop（僅註解修正）。
...
- Affected code:
  - Modified: crates/speclink-core/src/command/mod.rs、crates/speclink-core/src/tasks.rs、crates/speclink-core/src/store.rs、crates/speclink-host/src/bridge.rs、crates/speclink-host/src/drift.rs、crates/speclink-server/src/routes.rs、crates/speclink-store/src/types.rs、crates/speclink-store/src/memory.rs、crates/speclink-store/src/uow.rs、crates/speclink-store/src/conformance/mod.rs、crates/speclink-store-sqlite/src/lib.rs、crates/speclink-store-sqlite/src/schema.rs、crates/speclink-store-fs/src/lib.rs、crates/speclink-store-fs/src/layout.rs、crates/speclink-store-postgres/src/lib.rs、crates/speclink-store-postgres/src/schema.rs、crates/speclink-store-sqlite/tests/conformance.rs、crates/speclink-store-fs/tests/it/conformance.rs、crates/speclink-store-postgres/tests/it/conformance.rs、crates/speclink-server/tests/it/phase2_chain.rs、docs/product-status.zh-TW.md、docs/product-status.md、docs/remote-getting-started.zh-TW.md、docs/remote-getting-started.md、docs/roadmap.zh-TW.md、docs/roadmap.md、apps/desktop/src/session.ts
  - New: (none)
  - Removed: (none)
