# describe-tools-cli Specification

## Purpose

TBD - created by archiving change 'add-tool-describe-and-catalogue'. Update Purpose after archive.
...
<!-- @trace
source: add-tool-describe-and-catalogue
updated: 2026-05-23
code:
  ...
  - crates/cli/src/commands/describe_tools.rs
  - crates/runtime/src/tool_ops.rs
tests:
  - crates/cli/tests/snapshots/describe_tools__describe_tools_full_text.snap
  - crates/cli/tests/snapshots/describe_tools__describe_tools_curated_copilot_sdk.snap
  - crates/cli/tests/describe_tools.rs
  - crates/cli/tests/snapshots/describe_tools__describe_tools_default_json.snap
  - crates/runtime/tests/catalogue_doc_sync.rs
