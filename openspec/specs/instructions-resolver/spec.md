# instructions-resolver Specification

## Purpose

TBD - created by archiving change 'add-instructions-get'. Update Purpose after archive.
...
tests:
  - crates/runtime/tests/instructions_ops_schema_sync.rs
