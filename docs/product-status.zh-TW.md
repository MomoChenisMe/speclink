...
| Desktop 看板與詳情面板 | Available（可用） | Partial（部分可用） | 連線、登入與 chooser 開遠端看板皆可用；看板看得到 change 詮釋資料、capability 清單與認領人，詳情抽屜可直接認領。剩下的見能力表。 |
