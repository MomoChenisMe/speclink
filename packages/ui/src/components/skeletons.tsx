...
export function CardSkeleton({ className }: { className?: string }) {
  return (
    <div
      aria-busy="true"
      className={cn("rounded-xl border bg-card p-3 flex flex-col gap-2", className)}
    >
...
export function RowSkeleton({ className }: { className?: string }) {
  return (
    <div aria-busy="true" className={cn("flex items-center gap-2 px-2 py-1.5", className)}>
...
export function DocSkeleton({ className }: { className?: string }) {
  return (
    <div aria-busy="true" className={cn("flex flex-col gap-2 py-2", className)}>
