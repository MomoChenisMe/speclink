...
export const MESSAGES: Record<UiLocale, Dict> = {
  "zh-TW": {
    ...
    "discussion.headingPromoted": "已轉出討論",
    "discussion.showPromoted": "顯示已轉出討論",
    ...
    "rdrawer.delete": "刪除",
    "rdrawer.validatePass": "驗證通過",
    "rdrawer.validateFail": "驗證失敗",
    "analyze.clean": "無發現",
    "time.today": "今天",
    "time.yesterday": "昨天",
    "time.daysAgo": "{n} 天前",
  ...
  en: {
    ...
    "discussion.headingPromoted": "Promoted",
    "discussion.showPromoted": "Show promoted discussions",
    ...
    "rdrawer.validatePass": "Valid",
    "rdrawer.validateFail": "Invalid",
    "analyze.clean": "Clean",
    "time.today": "today",
